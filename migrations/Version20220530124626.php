 ...
 */
final class Version20220530124626 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE experience (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, title VARCHAR(255) NOT NULL, content LONGTEXT NOT NULL, image LONGTEXT NOT NULL, created_at DATETIME NOT NULL, location VARCHAR(255) NOT NULL, spots INT NOT NULL, duration INT NOT NULL, visible TINYINT(1) NOT NULL, archive TINYINT(1) NOT NULL, updated_at DATETIME DEFAULT NULL, INDEX IDX_590C103A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
